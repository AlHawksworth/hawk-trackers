...
// London Overground Lines (rebranded 2024)
const OVERGROUND_LINES = {
  ...
  lioness: {
    ...
    stations: [
      ...
      "Carpenders Park", "Hatch End", "Headstone Lane",
  ...
  liberty: {
    ...
    color: "#6F7B83",
    stations: [
      "Romford", "Emerson Park", "Upminster"
    ]
  },
  weaver: {
    name: "Weaver",
    color: "#B43D93",
    stations: [
      "Liverpool Street", "Bethnal Green", "Cambridge Heath",
      "London Fields", "Hackney Downs", "Rectory Road",
      "Stoke Newington", "Stamford Hill", "Seven Sisters",
      "Bruce Grove", "White Hart Lane", "Silver Street",
